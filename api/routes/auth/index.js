 ...
 * @apiName Login
 */
routes.post('/login', GetAccountTokenValidator, ValidationErrorsHandler, require('./postLogin'))
 ...
 */
routes.post('/account', RegisterAccountValidator, ValidationErrorsHandler, require('./postAccount'))
