...
/**
 * @api {get} /organizations/:org_id/clients/:client_id/comments/:comment_id Get organization client comment
 */
routes.get('/:comment_id', require('./getComment'))

/**
 * @api {post} /organizations/:org_id/clients/:client_id/comments Add to organization client
 */
routes.post('/', require('./createComment'))

/**
 * @api {put} /organizations/:org_id/clients/:client_id/comments/:comment_id Update organization client comment
 */
routes.put('/:comment_id', require('./updateComment'))
