...
exports.define = exports.tokenFlags = void 0;
...
const define = (sequelize, DataTypes) => {
    const Token = sequelize.define('Token', {
        ...
        flags: {
            ...
            type: DataTypes.SMALLINT, // 16 bits/flags
            allowNull: false,
            defaultValue: '0',
            get() {
                return (0, flags_1.readFlags)(this.getDataValue('flags') || 0, exports.tokenFlags);
            },
    ...
    Token.passwordResetTokenTemplate = (UserId) => {
        return {
            UserId,
            token: (0, utils_1.generateRandomCode)(128),
            expiresAt: new Date(new Date().getTime() + 24 * 60 * 60 * 1000), // 24 hours
            flags: exports.tokenFlags.USER_PASSWORD_RESET_TOKEN,
        };
    };
    /**
    ...
    Token.emailVerifyTokenTemplate = (UserId, email) => {
        return {
            UserId,
            token: (0, utils_1.generateRandomCode)(32),
            expiresAt: new Date(new Date().getTime() + 72 * 60 * 60 * 1000), // 72 hours
            flags: exports.tokenFlags.USER_EMAIL_VERIFY_TOKEN,
            data: email,
        };
    };
    /**
    ...
    Token.phoneVerifyTokenTemplate = (UserId, phoneCountry, phoneNumber) => {
        return {
            UserId,
            token: (0, utils_1.generateRandomCode)(6), // 6 digit code for phone verification
            expiresAt: new Date(new Date().getTime() + 24 * 60 * 60 * 1000), // 24 hours
            flags: exports.tokenFlags.USER_PHONE_VERIFY_TOKEN,
