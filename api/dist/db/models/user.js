...
exports.define = exports.UserFlags = void 0;
const flags_1 = require("../../utils/flags");
const bcrypt_1 = __importDefault(require("bcrypt"));
const utils_1 = require("../../utils");
const { hashSync } = bcrypt_1.default;
exports.UserFlags = {
...
function passwordChangeHook(user) {
    ...
    user.refreshToken = (0, utils_1.generateRefreshToken)();
}
const define = (sequelize, DataTypes) => {
    const User = sequelize.define('User', {
        ...
        refreshToken: {
            type: DataTypes.STRING(255),
            allowNull: false,
            defaultValue: (0, utils_1.generateRefreshToken)(),
        },
        flags: {
            ...
            // defaultValue: '0',
            get() {
                return (0, flags_1.readFlags)(this.getDataValue('flags'), exports.UserFlags);
            },
        },
    }, {
        hooks: {
