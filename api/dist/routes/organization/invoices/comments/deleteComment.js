...
exports.default = async (req, res) => {
    try {
        ...
        if (!invoiceId || !(0, isValidUUID_1.isValidUUID)(invoiceId))
            return res.status(400).json((0, response_1.createErrorResponse)('Invalid invoice id.'));
        ...
        await db_1.db.transaction(async (tx) => {
            ...
            const deleted = await tx.delete(db_1.comments)
                .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(db_1.comments.id, commentId), (0, drizzle_orm_1.eq)(db_1.comments.invoiceId, invoiceId), (0, drizzle_orm_1.eq)(db_1.comments.organizationId, orgId)))
                .returning();
            if (!deleted.length) {
