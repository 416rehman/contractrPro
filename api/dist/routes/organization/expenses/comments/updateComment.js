    ...
    try {
        ...
        await db_1.db.transaction(async (tx) => {
            ...
            const [comment] = await tx.update(db_1.comments)
                .set(body)
                .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(db_1.comments.id, commentId), (0, drizzle_orm_1.eq)(db_1.comments.organizationId, orgId), (0, drizzle_orm_1.eq)(db_1.comments.expenseId, expenseId)))
                .returning();
            if (!comment) {
